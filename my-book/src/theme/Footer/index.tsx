      ...
      <div className="footer-container">
        ...
        <div className="footer-column">
          ...
          <p className="footer-paragraph">
            Physical AI & Humanoid Robotics" delves into the fascinating world  of robotics, exploring the integration of artificial intelligence with physical systems to create humanoid robots that can interact seamlessly with their environment.
          </p>
        </div>
        ...
        <div className="footer-column">
          ...
          <div className="footer-socials">
            <a href="https://www.linkedin.com/in/rubina-shafiq-0a2236325/" target="_blank" className="social-icon">
            ...
            <a href="https://github.com/Rubinashafiq985" target="_blank" className="social-icon">
              <div className='foot-icon'>
            ...
            <a href="mailto:rubinashafiq985@gmail.com" className="social-icon">
              <div className='foot-icon'>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
